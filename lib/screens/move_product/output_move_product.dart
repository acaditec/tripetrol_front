...
class OutputMoveProductPage extends StatefulWidget {
  const OutputMoveProductPage({super.key});

  @override
  State<OutputMoveProductPage> createState() => _OutputMoveProductPageState();
}

class _OutputMoveProductPageState extends State<OutputMoveProductPage> {
